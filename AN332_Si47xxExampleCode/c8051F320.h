#ifndef _C8051F320_H_
#define _C8051F320_H_
/*---------------------------------------------------------------------------
;
;
;
...
;
;  REVISION 1.5
;   -- added sfr 'EIE2' and 'EIP2'
;  REVISION 1.4
;   -- added sfr 'EIP1', and sbit's 'ESPI0' and 'PSPI0'
;  REVISION 1.3
;   -- updated SPI0CN sbit definitions to match datasheet (NSSMD1, NSSMD0)
;  REVISION 1.2
...
sbit PSPI0   = IE ^ 6;     /* SPI0 INTERRUPT PRIORITY                               */
