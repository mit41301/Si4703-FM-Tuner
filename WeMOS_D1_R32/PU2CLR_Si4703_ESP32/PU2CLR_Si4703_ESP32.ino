...
*/
// Tested on 07/07/2026 with Sparkfun and local module. Reset Pin assigned to 04 instead of 25 to make it compatible with Other Serial Radio
#include <SI470X.h>

#define RESET_PIN 04       // 25 // On Arduino Atmega328 based board, this pin is labeled as A0 (14 means digital pin instead analog)
#define SDA_PIN   21       //  
...
void setup()
{
    ...
    Serial.print("\nEstacao 98.3MHz");
    rx.setFrequency(9830); // It is the frequency you want to select in MHz multiplied by 100.
